...
class HXCPP_CLASS_ATTRIBUTES Style_obj : public ::hx::Object
{
	...
	public:
		...
		::String cursor;
		 ::Dynamic cursorOffsetX;
		 ::Dynamic cursorOffsetY;
		 ::Dynamic hidden;
		...
		::Dynamic get_fullBorderSize_dyn();
		 ...
		 ::haxe::ds::StringMap customDirectives;
		...
		::Array< ::Dynamic> parseFilter( ::haxe::ui::styles::Value value,::Array< ::Dynamic> filters);
		::Dynamic parseFilter_dyn();
