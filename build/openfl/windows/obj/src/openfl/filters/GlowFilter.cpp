...
HXLINE( 297)				Float scale1 = (::Math_obj::pow(((Float)0.5),( (Float)(((blurPass1 - this->_hx___horizontalPasses) >> 1)) )) * ((Float)0.5));
HXLINE( 298)				shader->uRadius->value[0] = ( (Float)(0) );
HXLINE( 299)				shader->uRadius->value[1] = (this->get_blurY() * scale1);
            			}
...
HXLINE( 305)			Float _hx_tmp1;
HXDLIN( 305)			if ((blurPass1 == (numBlurPasses - 1))) {
HXLINE( 305)				_hx_tmp1 = this->_hx___strength;
            			}
            			else {
HXLINE( 305)				_hx_tmp1 = ((Float)1.0);
            			}
HXDLIN( 305)			shader->uStrength->value[0] = _hx_tmp1;
HXLINE( 306)			return shader;
            		}
HXLINE( 308)		if (this->_hx___inner) {
HXLINE( 310)			if (this->_hx___knockout) {
HXLINE( 312)				 ::openfl::filters::_GlowFilter::InnerCombineKnockoutShader shader1 = ::openfl::filters::GlowFilter_obj::_hx___innerCombineKnockoutShader;
HXLINE( 313)				shader1->sourceBitmap->input = sourceBitmapData;
HXLINE( 314)				shader1->offset->value[0] = ((Float)0.0);
HXLINE( 315)				shader1->offset->value[1] = ((Float)0.0);
HXLINE( 316)				return shader1;
            			}
HXLINE( 318)			 ::openfl::filters::_GlowFilter::InnerCombineShader shader2 = ::openfl::filters::GlowFilter_obj::_hx___innerCombineShader;
HXLINE( 319)			shader2->sourceBitmap->input = sourceBitmapData;
HXLINE( 320)			shader2->offset->value[0] = ((Float)0.0);
HXLINE( 321)			shader2->offset->value[1] = ((Float)0.0);
HXLINE( 322)			return shader2;
            		}
            		else {
HXLINE( 326)			if (this->_hx___knockout) {
HXLINE( 328)				 ::openfl::filters::_GlowFilter::CombineKnockoutShader shader3 = ::openfl::filters::GlowFilter_obj::_hx___combineKnockoutShader;
HXLINE( 329)				shader3->sourceBitmap->input = sourceBitmapData;
HXLINE( 330)				shader3->offset->value[0] = ((Float)0.0);
HXLINE( 331)				shader3->offset->value[1] = ((Float)0.0);
HXLINE( 332)				return shader3;
            			}
HXLINE( 334)			 ::openfl::filters::_GlowFilter::CombineShader shader4 = ::openfl::filters::GlowFilter_obj::_hx___combineShader;
HXLINE( 335)			shader4->sourceBitmap->input = sourceBitmapData;
HXLINE( 336)			shader4->offset->value[0] = ((Float)0.0);
HXLINE( 337)			shader4->offset->value[1] = ((Float)0.0);
HXLINE( 338)			return shader4;
            		}
