...
HX_LOCAL_STACK_FRAME(_hx_pos_6e95f8db175a4230_218_get_blurX,"openfl.filters.BlurFilter","get_blurX",0xeb11be0a,"openfl.filters.BlurFilter.get_blurX","openfl/filters/BlurFilter.hx",218,0x46563eac)
HX_LOCAL_STACK_FRAME(_hx_pos_6e95f8db175a4230_222_set_blurX,"openfl.filters.BlurFilter","set_blurX",0xce62aa16,"openfl.filters.BlurFilter.set_blurX","openfl/filters/BlurFilter.hx",222,0x46563eac)
HX_LOCAL_STACK_FRAME(_hx_pos_6e95f8db175a4230_235_get_blurY,"openfl.filters.BlurFilter","get_blurY",0xeb11be0b,"openfl.filters.BlurFilter.get_blurY","openfl/filters/BlurFilter.hx",235,0x46563eac)
HX_LOCAL_STACK_FRAME(_hx_pos_6e95f8db175a4230_239_set_blurY,"openfl.filters.BlurFilter","set_blurY",0xce62aa17,"openfl.filters.BlurFilter.set_blurY","openfl/filters/BlurFilter.hx",239,0x46563eac)
HX_LOCAL_STACK_FRAME(_hx_pos_6e95f8db175a4230_252_get_quality,"openfl.filters.BlurFilter","get_quality",0xa28f7338,"openfl.filters.BlurFilter.get_quality","openfl/filters/BlurFilter.hx",252,0x46563eac)
HX_LOCAL_STACK_FRAME(_hx_pos_6e95f8db175a4230_256_set_quality,"openfl.filters.BlurFilter","set_quality",0xacfc7a44,"openfl.filters.BlurFilter.set_quality","openfl/filters/BlurFilter.hx",256,0x46563eac)
...
Float BlurFilter_obj::get_blurX(){
            	HX_STACKFRAME(&_hx_pos_6e95f8db175a4230_218_get_blurX)
HXDLIN( 218)		return this->_hx___blurX;
            	}
...
Float BlurFilter_obj::set_blurX(Float value){
            	HX_STACKFRAME(&_hx_pos_6e95f8db175a4230_222_set_blurX)
HXLINE( 223)		if ((value != this->_hx___blurX)) {
HXLINE( 225)			this->_hx___blurX = value;
HXLINE( 226)			this->_hx___renderDirty = true;
HXLINE( 227)			int _hx_tmp;
HXDLIN( 227)			if ((value > 0)) {
HXLINE( 227)				_hx_tmp = ::Math_obj::ceil(value);
            			}
            			else {
HXLINE( 227)				_hx_tmp = 0;
            			}
HXDLIN( 227)			this->_hx___leftExtension = _hx_tmp;
HXLINE( 228)			this->_hx___rightExtension = this->_hx___leftExtension;
            		}
...
Float BlurFilter_obj::get_blurY(){
            	HX_STACKFRAME(&_hx_pos_6e95f8db175a4230_235_get_blurY)
HXDLIN( 235)		return this->_hx___blurY;
            	}
...
Float BlurFilter_obj::set_blurY(Float value){
            	HX_STACKFRAME(&_hx_pos_6e95f8db175a4230_239_set_blurY)
HXLINE( 240)		if ((value != this->_hx___blurY)) {
HXLINE( 242)			this->_hx___blurY = value;
HXLINE( 243)			this->_hx___renderDirty = true;
HXLINE( 244)			int _hx_tmp;
HXDLIN( 244)			if ((value > 0)) {
HXLINE( 244)				_hx_tmp = ::Math_obj::ceil(value);
            			}
            			else {
HXLINE( 244)				_hx_tmp = 0;
            			}
HXDLIN( 244)			this->_hx___topExtension = _hx_tmp;
HXLINE( 245)			this->_hx___bottomExtension = this->_hx___topExtension;
            		}
...
int BlurFilter_obj::get_quality(){
            	HX_STACKFRAME(&_hx_pos_6e95f8db175a4230_252_get_quality)
HXDLIN( 252)		return this->_hx___quality;
            	}
...
int BlurFilter_obj::set_quality(int value){
            	HX_STACKFRAME(&_hx_pos_6e95f8db175a4230_256_set_quality)
HXLINE( 259)		int _hx_tmp;
HXDLIN( 259)		if ((this->_hx___blurX <= 0)) {
HXLINE( 259)			_hx_tmp = 0;
            		}
            		else {
HXLINE( 259)			_hx_tmp = (::Math_obj::round((this->_hx___blurX * (( (Float)(value) ) / ( (Float)(4) )))) + 1);
            		}
HXDLIN( 259)		this->_hx___horizontalPasses = _hx_tmp;
HXLINE( 260)		int _hx_tmp1;
HXDLIN( 260)		if ((this->_hx___blurY <= 0)) {
HXLINE( 260)			_hx_tmp1 = 0;
            		}
            		else {
HXLINE( 260)			_hx_tmp1 = (::Math_obj::round((this->_hx___blurY * (( (Float)(value) ) / ( (Float)(4) )))) + 1);
            		}
HXDLIN( 260)		this->_hx___verticalPasses = _hx_tmp1;
HXLINE( 262)		this->_hx___numShaderPasses = (this->_hx___horizontalPasses + this->_hx___verticalPasses);
HXLINE( 264)		if ((value != this->_hx___quality)) {
HXLINE( 264)			this->_hx___renderDirty = true;
            		}
HXLINE( 265)		return (this->_hx___quality = value);
            	}
