...
HXLINE( 335)				Float scale1 = (::Math_obj::pow(((Float)0.5),( (Float)(((blurPass1 - this->_hx___horizontalPasses) >> 1)) )) * ((Float)0.5));
HXLINE( 336)				shader->uRadius->value[0] = ( (Float)(0) );
HXLINE( 337)				shader->uRadius->value[1] = (this->get_blurY() * scale1);
            			}
...
HXLINE( 343)			Float _hx_tmp1;
HXDLIN( 343)			if ((blurPass1 == (numBlurPasses - 1))) {
HXLINE( 343)				_hx_tmp1 = this->_hx___strength;
            			}
            			else {
HXLINE( 343)				_hx_tmp1 = ((Float)1.0);
            			}
HXDLIN( 343)			shader->uStrength->value[0] = _hx_tmp1;
HXLINE( 344)			return shader;
            		}
HXLINE( 346)		if (this->_hx___inner) {
HXLINE( 348)			bool _hx_tmp2;
HXDLIN( 348)			if (!(this->_hx___knockout)) {
HXLINE( 348)				_hx_tmp2 = this->_hx___hideObject;
            			}
            			else {
HXLINE( 348)				_hx_tmp2 = true;
            			}
HXDLIN( 348)			if (_hx_tmp2) {
HXLINE( 350)				 ::openfl::filters::_GlowFilter::InnerCombineKnockoutShader shader1 = ::openfl::filters::GlowFilter_obj::_hx___innerCombineKnockoutShader;
HXLINE( 351)				shader1->sourceBitmap->input = sourceBitmapData;
HXLINE( 352)				shader1->offset->value[0] = this->_hx___offsetX;
HXLINE( 353)				shader1->offset->value[1] = this->_hx___offsetY;
HXLINE( 354)				return shader1;
            			}
HXLINE( 356)			 ::openfl::filters::_GlowFilter::InnerCombineShader shader2 = ::openfl::filters::GlowFilter_obj::_hx___innerCombineShader;
HXLINE( 357)			shader2->sourceBitmap->input = sourceBitmapData;
HXLINE( 358)			shader2->offset->value[0] = this->_hx___offsetX;
HXLINE( 359)			shader2->offset->value[1] = this->_hx___offsetY;
HXLINE( 360)			return shader2;
            		}
            		else {
HXLINE( 364)			if (this->_hx___knockout) {
HXLINE( 366)				 ::openfl::filters::_GlowFilter::CombineKnockoutShader shader3 = ::openfl::filters::GlowFilter_obj::_hx___combineKnockoutShader;
HXLINE( 367)				shader3->sourceBitmap->input = sourceBitmapData;
HXLINE( 368)				shader3->offset->value[0] = this->_hx___offsetX;
HXLINE( 369)				shader3->offset->value[1] = this->_hx___offsetY;
HXLINE( 370)				return shader3;
            			}
            			else {
HXLINE( 372)				if (this->_hx___hideObject) {
HXLINE( 374)					 ::openfl::filters::_DropShadowFilter::HideShader shader4 = ::openfl::filters::DropShadowFilter_obj::_hx___hideShader;
HXLINE( 375)					shader4->sourceBitmap->input = sourceBitmapData;
HXLINE( 376)					shader4->offset->value[0] = this->_hx___offsetX;
HXLINE( 377)					shader4->offset->value[1] = this->_hx___offsetY;
HXLINE( 378)					return shader4;
            				}
            			}
HXLINE( 380)			 ::openfl::filters::_GlowFilter::CombineShader shader5 = ::openfl::filters::GlowFilter_obj::_hx___combineShader;
HXLINE( 381)			shader5->sourceBitmap->input = sourceBitmapData;
HXLINE( 382)			shader5->offset->value[0] = this->_hx___offsetX;
HXLINE( 383)			shader5->offset->value[1] = this->_hx___offsetY;
