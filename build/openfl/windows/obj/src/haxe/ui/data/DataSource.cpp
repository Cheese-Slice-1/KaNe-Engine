...
HX_LOCAL_STACK_FRAME(_hx_pos_98c3d89b78a0c130_166_sortByFn,"haxe.ui.data.DataSource","sortByFn",0x9560c914,"haxe.ui.data.DataSource.sortByFn","haxe/ui/data/DataSource.hx",166,0xca832966)
HX_LOCAL_STACK_FRAME(_hx_pos_98c3d89b78a0c130_206_handleGetSize,"haxe.ui.data.DataSource","handleGetSize",0xbf1cdeb8,"haxe.ui.data.DataSource.handleGetSize","haxe/ui/data/DataSource.hx",206,0xca832966)
HX_LOCAL_STACK_FRAME(_hx_pos_98c3d89b78a0c130_210_handleGetItem,"haxe.ui.data.DataSource","handleGetItem",0xb889030a,"haxe.ui.data.DataSource.handleGetItem","haxe/ui/data/DataSource.hx",210,0xca832966)
HX_LOCAL_STACK_FRAME(_hx_pos_98c3d89b78a0c130_214_handleIndexOf,"haxe.ui.data.DataSource","handleIndexOf",0x8105d70a,"haxe.ui.data.DataSource.handleIndexOf","haxe/ui/data/DataSource.hx",214,0xca832966)
HX_LOCAL_STACK_FRAME(_hx_pos_98c3d89b78a0c130_218_handleAddItem,"haxe.ui.data.DataSource","handleAddItem",0x22439615,"haxe.ui.data.DataSource.handleAddItem","haxe/ui/data/DataSource.hx",218,0xca832966)
HX_LOCAL_STACK_FRAME(_hx_pos_98c3d89b78a0c130_222_handleInsert,"haxe.ui.data.DataSource","handleInsert",0x6654f818,"haxe.ui.data.DataSource.handleInsert","haxe/ui/data/DataSource.hx",222,0xca832966)
HX_LOCAL_STACK_FRAME(_hx_pos_98c3d89b78a0c130_226_handleRemoveItem,"haxe.ui.data.DataSource","handleRemoveItem",0x199c0fd6,"haxe.ui.data.DataSource.handleRemoveItem","haxe/ui/data/DataSource.hx",226,0xca832966)
HX_LOCAL_STACK_FRAME(_hx_pos_98c3d89b78a0c130_230_handleGetData,"haxe.ui.data.DataSource","handleGetData",0xb52c9421,"haxe.ui.data.DataSource.handleGetData","haxe/ui/data/DataSource.hx",230,0xca832966)
HX_LOCAL_STACK_FRAME(_hx_pos_98c3d89b78a0c130_233_handleSetData,"haxe.ui.data.DataSource","handleSetData",0xa82e252d,"haxe.ui.data.DataSource.handleSetData","haxe/ui/data/DataSource.hx",233,0xca832966)
HX_LOCAL_STACK_FRAME(_hx_pos_98c3d89b78a0c130_236_handleClear,"haxe.ui.data.DataSource","handleClear",0x1b563d8e,"haxe.ui.data.DataSource.handleClear","haxe/ui/data/DataSource.hx",236,0xca832966)
HX_LOCAL_STACK_FRAME(_hx_pos_98c3d89b78a0c130_246_handleUpdateItem,"haxe.ui.data.DataSource","handleUpdateItem",0x5531c01b,"haxe.ui.data.DataSource.handleUpdateItem","haxe/ui/data/DataSource.hx",246,0xca832966)
HX_LOCAL_STACK_FRAME(_hx_pos_98c3d89b78a0c130_249_clone,"haxe.ui.data.DataSource","clone",0x0da40766,"haxe.ui.data.DataSource.clone","haxe/ui/data/DataSource.hx",249,0xca832966)
HX_LOCAL_STACK_FRAME(_hx_pos_98c3d89b78a0c130_255_onDataItemChange,"haxe.ui.data.DataSource","onDataItemChange",0x482641c3,"haxe.ui.data.DataSource.onDataItemChange","haxe/ui/data/DataSource.hx",255,0xca832966)
HX_LOCAL_STACK_FRAME(_hx_pos_98c3d89b78a0c130_262_onInternalChange,"haxe.ui.data.DataSource","onInternalChange",0x6fae6ca3,"haxe.ui.data.DataSource.onInternalChange","haxe/ui/data/DataSource.hx",262,0xca832966)
HX_LOCAL_STACK_FRAME(_hx_pos_98c3d89b78a0c130_273_fromString,"haxe.ui.data.DataSource","fromString",0x3474f932,"haxe.ui.data.DataSource.fromString","haxe/ui/data/DataSource.hx",273,0xca832966)
HX_LOCAL_STACK_FRAME(_hx_pos_98c3d89b78a0c130_164_boot,"haxe.ui.data.DataSource","boot",0x2796a449,"haxe.ui.data.DataSource.boot","haxe/ui/data/DataSource.hx",164,0xca832966)
HX_LOCAL_STACK_FRAME(_hx_pos_98c3d89b78a0c130_165_boot,"haxe.ui.data.DataSource","boot",0x2796a449,"haxe.ui.data.DataSource.boot","haxe/ui/data/DataSource.hx",165,0xca832966)
namespace haxe{
namespace ui{
namespace data{
...
int DataSource_obj::add( ::Dynamic item){
            	HX_STACKFRAME(&_hx_pos_98c3d89b78a0c130_74_add)
HXLINE(  75)		int index = this->handleAddItem(item);
...
HXLINE(  78)			this->onAdd(item);
            		}
HXLINE(  80)		return index;
            	}
...
int DataSource_obj::sortByFn( ::Dynamic o1, ::Dynamic o2,::String direction,::String field){
            	HX_STACKFRAME(&_hx_pos_98c3d89b78a0c130_166_sortByFn)
HXLINE( 167)		 ::Dynamic f1 = o1;
HXLINE( 168)		 ::Dynamic f2 = o2;
HXLINE( 170)		if (::hx::IsNotNull( field )) {
HXLINE( 171)			f1 = ::Reflect_obj::field(o1,field);
HXLINE( 172)			f2 = ::Reflect_obj::field(o2,field);
            		}
HXLINE( 175)		bool _hx_tmp;
HXDLIN( 175)		if (::hx::IsNotNull( f1 )) {
HXLINE( 175)			_hx_tmp = ::hx::IsNull( f2 );
            		}
            		else {
...
HXLINE( 179)		f1 = ::Std_obj::string(f1);
HXLINE( 180)		f2 = ::Std_obj::string(f2);
HXLINE( 182)		if (::hx::IsNull( direction )) {
HXLINE( 183)			direction = HX_("asc",31,ff,49,00);
            		}
HXLINE( 186)		int high = 1;
HXLINE( 187)		int low = -1;
HXLINE( 188)		if ((direction == HX_("desc",51,5e,66,42))) {
HXLINE( 189)			high = -1;
HXLINE( 190)			low = 1;
            		}
HXLINE( 193)		::String alpha1 = ::haxe::ui::data::DataSource_obj::regexAlpha->replace(( (::String)(f1) ),HX_("",00,00,00,00));
HXLINE( 194)		::String alpha2 = ::haxe::ui::data::DataSource_obj::regexAlpha->replace(( (::String)(f2) ),HX_("",00,00,00,00));
HXLINE( 195)		if ((alpha1 == alpha2)) {
HXLINE( 196)			 ::Dynamic numeric1 = ::Std_obj::parseInt(::haxe::ui::data::DataSource_obj::regexNumeric->replace(( (::String)(f1) ),HX_("",00,00,00,00)));
HXLINE( 197)			 ::Dynamic numeric2 = ::Std_obj::parseInt(::haxe::ui::data::DataSource_obj::regexNumeric->replace(( (::String)(f2) ),HX_("",00,00,00,00)));
HXLINE( 198)			if (::hx::IsEq( numeric1,numeric2 )) {
HXLINE( 198)				return 0;
            			}
            			else {
HXLINE( 198)				if (::hx::IsGreater( numeric1,numeric2 )) {
HXLINE( 198)					return high;
            				}
            				else {
HXLINE( 198)					return low;
            				}
            			}
            		}
HXLINE( 201)		if ((alpha1 > alpha2)) {
HXLINE( 201)			return high;
            		}
            		else {
HXLINE( 201)			return low;
            		}
HXDLIN( 201)		return 0;
            	}
...
int DataSource_obj::handleGetSize(){
            	HX_STACKFRAME(&_hx_pos_98c3d89b78a0c130_206_handleGetSize)
HXDLIN( 206)		return 0;
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(DataSource_obj,handleGetSize,return )
 ...
 ::Dynamic DataSource_obj::handleGetItem(int index){
            	HX_STACKFRAME(&_hx_pos_98c3d89b78a0c130_210_handleGetItem)
...
int DataSource_obj::handleIndexOf( ::Dynamic item){
            	HX_STACKFRAME(&_hx_pos_98c3d89b78a0c130_214_handleIndexOf)
HXDLIN( 214)		return 0;
            	}
...
int DataSource_obj::handleAddItem( ::Dynamic item){
            	HX_STACKFRAME(&_hx_pos_98c3d89b78a0c130_218_handleAddItem)
HXDLIN( 218)		return -1;
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(DataSource_obj,handleAddItem,return )
 ...
 ::Dynamic DataSource_obj::handleInsert(int index, ::Dynamic item){
            	HX_STACKFRAME(&_hx_pos_98c3d89b78a0c130_222_handleInsert)
...
HX_DEFINE_DYNAMIC_FUNC2(DataSource_obj,handleInsert,return )
 ...
 ::Dynamic DataSource_obj::handleRemoveItem( ::Dynamic item){
            	HX_STACKFRAME(&_hx_pos_98c3d89b78a0c130_226_handleRemoveItem)
...
HX_DEFINE_DYNAMIC_FUNC1(DataSource_obj,handleRemoveItem,return )
 ...
 ::Dynamic DataSource_obj::handleGetData(){
            	HX_STACKFRAME(&_hx_pos_98c3d89b78a0c130_230_handleGetData)
...
void DataSource_obj::handleSetData( ::Dynamic v){
            	HX_STACKFRAME(&_hx_pos_98c3d89b78a0c130_233_handleSetData)
            	}
...
void DataSource_obj::handleClear(){
            	HX_STACKFRAME(&_hx_pos_98c3d89b78a0c130_236_handleClear)
HXLINE( 237)		::Dynamic cachedTransformer = this->transformer;
HXLINE( 238)		this->transformer = null();
HXLINE( 239)		while((this->get_size() > 0)){
HXLINE( 240)			this->remove(this->get(0));
            		}
HXLINE( 242)		this->transformer = cachedTransformer;
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(DataSource_obj,handleClear,(void))
 ...
 ::Dynamic DataSource_obj::handleUpdateItem(int index, ::Dynamic item){
            	HX_STACKFRAME(&_hx_pos_98c3d89b78a0c130_246_handleUpdateItem)
...
HX_DEFINE_DYNAMIC_FUNC2(DataSource_obj,handleUpdateItem,return )
 ...
 ::haxe::ui::data::DataSource DataSource_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_98c3d89b78a0c130_249_clone)
HXLINE( 250)		 ::haxe::ui::data::DataSource c =  ::haxe::ui::data::DataSource_obj::__alloc( HX_CTX ,null());
HXLINE( 251)		return c;
            	}
...
void DataSource_obj::onDataItemChange(){
            	HX_STACKFRAME(&_hx_pos_98c3d89b78a0c130_255_onDataItemChange)
HXDLIN( 255)		if (::hx::IsNotNull( this->_filterFn )) {
HXLINE( 256)			this->handleFilter(this->_filterFn);
            		}
            		else {
HXLINE( 258)			this->onInternalChange();
            		}
            	}
...
void DataSource_obj::onInternalChange(){
            	HX_STACKFRAME(&_hx_pos_98c3d89b78a0c130_262_onInternalChange)
HXLINE( 263)		if (::hx::IsNotNull( this->onDataSourceChange )) {
HXLINE( 264)			this->onDataSourceChange();
            		}
HXLINE( 266)		if (::hx::IsNotNull( this->onChange )) {
HXLINE( 267)			this->onChange();
            		}
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(DataSource_obj,onInternalChange,(void))
 ...
 ::EReg DataSource_obj::regexAlpha;

 ::EReg DataSource_obj::regexNumeric;

 ::haxe::ui::data::DataSource DataSource_obj::fromString(::String data,::hx::Class type){
            	HX_STACKFRAME(&_hx_pos_98c3d89b78a0c130_273_fromString)
...
bool DataSource_obj::__GetStatic(const ::String &inName, Dynamic &outValue, ::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 10:
		if (HX_FIELD_EQ(inName,"regexAlpha") ) { outValue = ( regexAlpha ); return true; }
		if (HX_FIELD_EQ(inName,"fromString") ) { outValue = fromString_dyn(); return true; }
		break;
	case 12:
		if (HX_FIELD_EQ(inName,"regexNumeric") ) { outValue = ( regexNumeric ); return true; }
	}
	return false;
}
...
bool DataSource_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 10:
		if (HX_FIELD_EQ(inName,"regexAlpha") ) { regexAlpha=ioValue.Cast<  ::EReg >(); return true; }
		break;
	case 12:
		if (HX_FIELD_EQ(inName,"regexNumeric") ) { regexNumeric=ioValue.Cast<  ::EReg >(); return true; }
	}
	return false;
}
...
static ::hx::StaticInfo DataSource_obj_sStaticStorageInfo[] = {
	{::hx::fsObject /*  ::EReg */ ,(void *) &DataSource_obj::regexAlpha,HX_("regexAlpha",17,f7,42,f5)},
	{::hx::fsObject /*  ::EReg */ ,(void *) &DataSource_obj::regexNumeric,HX_("regexNumeric",c6,52,eb,fe)},
	{ ::hx::fsUnknown, 0, null()}
};
#endif
...
static void DataSource_obj_sMarkStatics(HX_MARK_PARAMS) {
	HX_MARK_MEMBER_NAME(DataSource_obj::regexAlpha,"regexAlpha");
	HX_MARK_MEMBER_NAME(DataSource_obj::regexNumeric,"regexNumeric");
};

#ifdef HXCPP_VISIT_ALLOCS
static void DataSource_obj_sVisitStatics(HX_VISIT_PARAMS) {
	HX_VISIT_MEMBER_NAME(DataSource_obj::regexAlpha,"regexAlpha");
	HX_VISIT_MEMBER_NAME(DataSource_obj::regexNumeric,"regexNumeric");
};
...
static ::String DataSource_obj_sStaticFields[] = {
	HX_("regexAlpha",17,f7,42,f5),
	HX_("regexNumeric",c6,52,eb,fe),
...
{
{
            	HX_GC_STACKFRAME(&_hx_pos_98c3d89b78a0c130_164_boot)
HXDLIN( 164)		regexAlpha =  ::EReg_obj::__alloc( HX_CTX ,HX_("[^a-zA-Z]",9a,8e,03,26),HX_("g",67,00,00,00));
            	}
{
            	HX_GC_STACKFRAME(&_hx_pos_98c3d89b78a0c130_165_boot)
HXDLIN( 165)		regexNumeric =  ::EReg_obj::__alloc( HX_CTX ,HX_("[^0-9]",64,f2,00,a2),HX_("g",67,00,00,00));
            	}
}
