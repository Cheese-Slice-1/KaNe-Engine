...
HXLINE(  20)		::haxe::ui::core::Screen_obj::get_instance()->registerEvent(::haxe::ui::events::KeyboardEvent_obj::KEY_DOWN,this->onKeyDown_dyn(),null());
HXLINE(  21)		::haxe::ui::core::Screen_obj::get_instance()->registerEvent(::haxe::ui::events::KeyboardEvent_obj::KEY_UP,this->onKeyUp_dyn(),null());
            	}
