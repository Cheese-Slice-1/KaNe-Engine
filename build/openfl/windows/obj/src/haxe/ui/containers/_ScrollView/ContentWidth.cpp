...
HXLINE( 228)		return ::haxe::ui::util::_Variant::Variant_Impl__obj::fromFloat(contents->get_width());
            	}
...
HXLINE( 235)			contents->set_width(( (Float)(::haxe::ui::util::_Variant::Variant_Impl__obj::toFloat(value)) ));
            		}
            	}
