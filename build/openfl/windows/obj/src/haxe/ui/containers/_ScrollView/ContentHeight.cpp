...
HXLINE( 267)		return ::haxe::ui::util::_Variant::Variant_Impl__obj::fromFloat(contents->get_height());
            	}
...
HXLINE( 274)			contents->set_height(( (Float)(::haxe::ui::util::_Variant::Variant_Impl__obj::toFloat(value)) ));
            		}
            	}
