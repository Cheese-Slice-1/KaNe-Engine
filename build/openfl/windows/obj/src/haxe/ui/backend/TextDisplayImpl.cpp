...
HXLINE(  69)				 ::openfl::text::TextField _hx_tmp1 = this->textField;
HXDLIN(  69)				_hx_tmp1->set_htmlText(this->normalizeText(this->_htmlText));
            			}
            		}
            	}
...
HXLINE( 121)		bool _hx_tmp4 = this->textField->get_wordWrap();
HXDLIN( 121)		if ((_hx_tmp4 != this->_displayData->wordWrap)) {
HXLINE( 122)			this->textField->set_wordWrap(this->_displayData->wordWrap);
HXLINE( 123)			measureTextRequired = true;
            		}
HXLINE( 125)		bool _hx_tmp5;
HXDLIN( 125)		if ((this->_resetHtmlText == true)) {
HXLINE( 125)			_hx_tmp5 = ::hx::IsNotNull( this->_htmlText );
            		}
            		else {
HXLINE( 125)			_hx_tmp5 = false;
            		}
HXDLIN( 125)		if (_hx_tmp5) {
HXLINE( 126)			 ::openfl::text::TextField _hx_tmp6 = this->textField;
HXDLIN( 126)			_hx_tmp6->set_htmlText(this->normalizeText(this->_htmlText));
            		}
HXLINE( 129)		bool _hx_tmp7 = this->textField->get_multiline();
HXDLIN( 129)		if ((_hx_tmp7 != this->_displayData->multiline)) {
...
HXLINE( 215)			 ::haxe::ui::backend::TextDisplayImpl _hx_tmp1 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 215)			_hx_tmp1->_textWidth = (_hx_tmp1->_textWidth + 1);
            		}
HXLINE( 217)		this->_textHeight = ( (Float)(::Math_obj::round(this->_textHeight)) );
HXLINE( 218)		if ((::hx::Mod(this->_textHeight,2) == 0)) {
HXLINE( 219)			 ::haxe::ui::backend::TextDisplayImpl _hx_tmp2 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 219)			_hx_tmp2->_textHeight = (_hx_tmp2->_textHeight + 1);
            		}
            	}
