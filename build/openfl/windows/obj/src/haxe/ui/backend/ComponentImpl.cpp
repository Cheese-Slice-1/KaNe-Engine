...
HXDLIN(  46)		if (::hx::IsNull( component->get_parentComponent() )) {
...
HXDLIN(  60)		if (::hx::IsNull( component->get_parentComponent() )) {
...
HXLINE( 297)			if ((this->_eventMap->exists(::haxe::ui::events::UIEvent_obj::CHANGE) == false)) {
HXLINE( 298)				if ((this->hasTextInput() == true)) {
HXLINE( 299)					this->_eventMap->set(::haxe::ui::events::UIEvent_obj::CHANGE,listener);
...
HXLINE( 365)		 ::Dynamic fn = this->_eventMap->get(::haxe::ui::events::UIEvent_obj::CHANGE);
HXLINE( 366)		if (::hx::IsNotNull( fn )) {
HXLINE( 367)			fn( ::haxe::ui::events::UIEvent_obj::__alloc( HX_CTX ,::haxe::ui::events::UIEvent_obj::CHANGE,null(),null()));
            		}
            	}
