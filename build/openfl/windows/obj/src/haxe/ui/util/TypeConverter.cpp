...
HXLINE(  34)			goto _hx_goto_1;
            		...
            		if (  (_hx_switch_0==HX_("dynamic",7f,9f,15,36)) ||  (_hx_switch_0==HX_("scalemode",ed,ae,fa,40)) ||  (_hx_switch_0==HX_("scrollmode",f0,35,47,1b)) ||  (_hx_switch_0==HX_("scrollpolicy",bf,bb,53,1c)) ||  (_hx_switch_0==HX_("selectionmode",af,e1,cb,0d)) ||  (_hx_switch_0==HX_("variant",85,40,e2,dc)) ){
