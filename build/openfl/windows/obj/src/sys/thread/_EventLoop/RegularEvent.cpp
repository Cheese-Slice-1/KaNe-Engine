...
HX_DEFINE_STACK_FRAME(_hx_pos_c534138fa267e147_278_new,"sys.thread._EventLoop.RegularEvent","new",0x9d3b475c,"sys.thread._EventLoop.RegularEvent.new","C:\\Users\\loiro\\scoop\\apps\\haxe\\current\\std/sys/thread/EventLoop.hx",278,0x22d3111a)
namespace sys{
namespace thread{
namespace _EventLoop{

void RegularEvent_obj::__construct( ::Dynamic run,Float nextRunTime,Float interval){
            	HX_STACKFRAME(&_hx_pos_c534138fa267e147_278_new)
