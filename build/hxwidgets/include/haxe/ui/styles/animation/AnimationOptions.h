...
class HXCPP_CLASS_ATTRIBUTES AnimationOptions_obj : public ::hx::Object
{
	...
	public:
		...
		void __construct( ::Dynamic duration, ::Dynamic delay, ::Dynamic iterationCount,::String easingFunction,::String direction,::String fillMode);
		...
		static ::hx::ObjectPtr< AnimationOptions_obj > __new( ::Dynamic duration, ::Dynamic delay, ::Dynamic iterationCount,::String easingFunction,::String direction,::String fillMode);
		static ::hx::ObjectPtr< AnimationOptions_obj > __alloc(::hx::Ctx *_hx_ctx, ::Dynamic duration, ::Dynamic delay, ::Dynamic iterationCount,::String easingFunction,::String direction,::String fillMode);
		...
		static ::String DEFAULT_EASING_FUNCTION;
