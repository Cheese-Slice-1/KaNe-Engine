...
HX_LOCAL_STACK_FRAME(_hx_pos_b6a660bd5bf0b597_49_setBitmap,"hx.widgets.TaskBarIcon","setBitmap",0x278196ad,"hx.widgets.TaskBarIcon.setBitmap","hx/widgets/TaskBarIcon.hx",49,0xd5fb5a96)
...
HXDLIN(  27)		 wxString _hx_tmp2 = wxString::FromUTF8(tooltip.utf8_str());
...
void TaskBarIcon_obj::setBitmap( ::hx::widgets::Bitmap bitmap,::String tooltip){
            	HX_GC_STACKFRAME(&_hx_pos_b6a660bd5bf0b597_49_setBitmap)
HXLINE(  50)		 ::hx::widgets::Icon icon =  ::hx::widgets::Icon_obj::__alloc( HX_CTX );
HXLINE(  51)		icon->copyFromBitmap(bitmap);
HXLINE(  52)		 wxTaskBarIcon * _hx_tmp = this->get_taskBarIconRef()->ptr;
HXDLIN(  52)		 wxIcon & _hx_tmp1 = icon->get_iconRef()->get_ref();
HXDLIN(  52)		 wxString _hx_tmp2 = wxString::FromUTF8(tooltip.utf8_str());
HXDLIN(  52)		(*(_hx_tmp)).SetIcon(_hx_tmp1,_hx_tmp2);
            	}
