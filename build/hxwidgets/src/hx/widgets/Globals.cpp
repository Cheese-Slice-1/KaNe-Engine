...
HXLINE(  30)		 wxProcess* pCallback = null();
HXLINE(  31)		if (::hx::IsNotNull( callback )) {
HXLINE(  32)			pCallback = callback->get_processRef()->get_raw();
            		}
HXLINE(  35)		 wxExecuteEnv* pEnv = null();
HXLINE(  36)		::String s = ( (::String)(env->__Field(HX_("cwd",30,87,4b,00),::hx::paccDynamic)) );
HXLINE(  37)		::cpp::Pointer<  wxString > cwd = ::cpp::Pointer_obj::fromRaw((new wxString(s.utf8_str())));
HXLINE(  38)		::cpp::Pointer<  wxStringToStringHashMap > map = ::cpp::Pointer_obj::fromRaw((new wxStringToStringHashMap()));
HXLINE(  39)		 wxString cwd1 = cwd->get_ref();
HXDLIN(  39)		 wxStringToStringHashMap env1 = map->get_ref();
HXDLIN(  39)		 wxExecuteEnv param = { cwd1, env1 };
HXLINE(  40)		pEnv = ::cpp::Pointer_obj::addressOf(param)->get_raw();
HXLINE(  42)		::cpp::Pointer<  wxString > wxCmd = ::cpp::Pointer_obj::fromRaw((new wxString(cmd.utf8_str())));
HXLINE(  43)		int pid = ::wxExecute(wxCmd->get_ref(),flags,pCallback,pEnv);
HXLINE(  44)		wxCmd->destroy();
HXLINE(  46)		return pid;
            	}
