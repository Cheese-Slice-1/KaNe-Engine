...
HX_DEFINE_STACK_FRAME(_hx_pos_78127945634db073_26_new,"Date","new",0x9aa26240,"Date.new","C:\\Users\\loiro\\scoop\\apps\\haxe\\current\\std/cpp/_std/Date.hx",26,0xf3d0829a)
HX_LOCAL_STACK_FRAME(_hx_pos_78127945634db073_30_getTime,"Date","getTime",0x0cac7da3,"Date.getTime","C:\\Users\\loiro\\scoop\\apps\\haxe\\current\\std/cpp/_std/Date.hx",30,0xf3d0829a)
HX_LOCAL_STACK_FRAME(_hx_pos_78127945634db073_34_getHours,"Date","getHours",0x256fe079,"Date.getHours","C:\\Users\\loiro\\scoop\\apps\\haxe\\current\\std/cpp/_std/Date.hx",34,0xf3d0829a)
HX_LOCAL_STACK_FRAME(_hx_pos_78127945634db073_38_getMinutes,"Date","getMinutes",0xad798749,"Date.getMinutes","C:\\Users\\loiro\\scoop\\apps\\haxe\\current\\std/cpp/_std/Date.hx",38,0xf3d0829a)
HX_LOCAL_STACK_FRAME(_hx_pos_78127945634db073_42_getSeconds,"Date","getSeconds",0xb428a6a9,"Date.getSeconds","C:\\Users\\loiro\\scoop\\apps\\haxe\\current\\std/cpp/_std/Date.hx",42,0xf3d0829a)
HX_LOCAL_STACK_FRAME(_hx_pos_78127945634db073_46_getFullYear,"Date","getFullYear",0x72528782,"Date.getFullYear","C:\\Users\\loiro\\scoop\\apps\\haxe\\current\\std/cpp/_std/Date.hx",46,0xf3d0829a)
HX_LOCAL_STACK_FRAME(_hx_pos_78127945634db073_50_getMonth,"Date","getMonth",0x066b78ea,"Date.getMonth","C:\\Users\\loiro\\scoop\\apps\\haxe\\current\\std/cpp/_std/Date.hx",50,0xf3d0829a)
HX_LOCAL_STACK_FRAME(_hx_pos_78127945634db073_54_getDate,"Date","getDate",0x021307c4,"Date.getDate","C:\\Users\\loiro\\scoop\\apps\\haxe\\current\\std/cpp/_std/Date.hx",54,0xf3d0829a)
HX_LOCAL_STACK_FRAME(_hx_pos_78127945634db073_58_getDay,"Date","getDay",0x598d4986,"Date.getDay","C:\\Users\\loiro\\scoop\\apps\\haxe\\current\\std/cpp/_std/Date.hx",58,0xf3d0829a)
HX_LOCAL_STACK_FRAME(_hx_pos_78127945634db073_94_toString,"Date","toString",0xd2a372cc,"Date.toString","C:\\Users\\loiro\\scoop\\apps\\haxe\\current\\std/cpp/_std/Date.hx",94,0xf3d0829a)
HX_LOCAL_STACK_FRAME(_hx_pos_78127945634db073_98_now,"Date","now",0x9aa26af6,"Date.now","C:\\Users\\loiro\\scoop\\apps\\haxe\\current\\std/cpp/_std/Date.hx",98,0xf3d0829a)
HX_LOCAL_STACK_FRAME(_hx_pos_78127945634db073_105_fromTime,"Date","fromTime",0x44fd3cb7,"Date.fromTime","C:\\Users\\loiro\\scoop\\apps\\haxe\\current\\std/cpp/_std/Date.hx",105,0xf3d0829a)
HX_LOCAL_STACK_FRAME(_hx_pos_78127945634db073_112_fromString,"Date","fromString",0x5ead97fb,"Date.fromString","C:\\Users\\loiro\\scoop\\apps\\haxe\\current\\std/cpp/_std/Date.hx",112,0xf3d0829a)

void Date_obj::__construct(int year,int month,int day,int hour,int min,int sec){
            	HX_STACKFRAME(&_hx_pos_78127945634db073_26_new)
...
Float Date_obj::getTime(){
            	HX_STACKFRAME(&_hx_pos_78127945634db073_30_getTime)
...
int Date_obj::getHours(){
            	HX_STACKFRAME(&_hx_pos_78127945634db073_34_getHours)
...
int Date_obj::getMinutes(){
            	HX_STACKFRAME(&_hx_pos_78127945634db073_38_getMinutes)
...
int Date_obj::getSeconds(){
            	HX_STACKFRAME(&_hx_pos_78127945634db073_42_getSeconds)
...
int Date_obj::getFullYear(){
            	HX_STACKFRAME(&_hx_pos_78127945634db073_46_getFullYear)
...
int Date_obj::getMonth(){
            	HX_STACKFRAME(&_hx_pos_78127945634db073_50_getMonth)
...
int Date_obj::getDate(){
            	HX_STACKFRAME(&_hx_pos_78127945634db073_54_getDate)
...
int Date_obj::getDay(){
            	HX_STACKFRAME(&_hx_pos_78127945634db073_58_getDay)
...
::String Date_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_78127945634db073_94_toString)
...
HX_DEFINE_DYNAMIC_FUNC0(Date_obj,toString,return )
 ...
 ::Date Date_obj::now(){
            	HX_STACKFRAME(&_hx_pos_78127945634db073_98_now)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC0(Date_obj,now,return )
 ...
 ::Date Date_obj::fromTime(Float t){
            	HX_GC_STACKFRAME(&_hx_pos_78127945634db073_105_fromTime)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Date_obj,fromTime,return )
 ...
 ::Date Date_obj::fromString(::String s){
            	HX_GC_STACKFRAME(&_hx_pos_78127945634db073_112_fromString)
