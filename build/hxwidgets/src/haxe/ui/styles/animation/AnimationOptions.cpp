...
void AnimationOptions_obj::__construct( ::Dynamic duration, ::Dynamic delay, ::Dynamic iterationCount,::String easingFunction,::String direction,::String fillMode){
...
HXDLIN(  27)			_hx_tmp1 = (op->easingFunction == this->easingFunction);
            		}
            		else {
...
HXLINE(  41)				_hx_tmp8 = (anim->easingFunction == ::haxe::ui::styles::animation::AnimationOptions_obj::DEFAULT_EASING_FUNCTION);
            			}
            			else {
...
HXDLIN(  38)					_hx_tmp1 = (anim->easingFunction == this->easingFunction);
            				}
            				else {
...
::String AnimationOptions_obj::DEFAULT_EASING_FUNCTION;
...
::hx::ObjectPtr< AnimationOptions_obj > AnimationOptions_obj::__new( ::Dynamic duration, ::Dynamic delay, ::Dynamic iterationCount,::String easingFunction,::String direction,::String fillMode) {
...
::hx::ObjectPtr< AnimationOptions_obj > AnimationOptions_obj::__alloc(::hx::Ctx *_hx_ctx, ::Dynamic duration, ::Dynamic delay, ::Dynamic iterationCount,::String easingFunction,::String direction,::String fillMode) {
...
bool AnimationOptions_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 23:
		if (HX_FIELD_EQ(inName,"DEFAULT_EASING_FUNCTION") ) { DEFAULT_EASING_FUNCTION=ioValue.Cast< ::String >(); return true; }
	}
	return false;
}
...
static ::hx::StorageInfo AnimationOptions_obj_sMemberStorageInfo[] = {
	...
	{::hx::fsString,(int)offsetof(AnimationOptions_obj,easingFunction),HX_("easingFunction",e3,d6,ae,0d)},
...
static ::hx::StaticInfo AnimationOptions_obj_sStaticStorageInfo[] = {
	...
	{::hx::fsString,(void *) &AnimationOptions_obj::DEFAULT_EASING_FUNCTION,HX_("DEFAULT_EASING_FUNCTION",8e,4d,93,51)},
...
HXDLIN(  14)		DEFAULT_EASING_FUNCTION = HX_("ease",ee,8b,0c,43);
            	}
{
