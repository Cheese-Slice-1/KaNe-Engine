...
void ActuatorOptions_obj::__construct( ::Dynamic delay,::String easingFunction, ::Dynamic onComplete, ::Dynamic onUpdate){
...
static ::hx::StorageInfo ActuatorOptions_obj_sMemberStorageInfo[] = {
	...
	{::hx::fsString,(int)offsetof(ActuatorOptions_obj,easingFunction),HX_("easingFunction",e3,d6,ae,0d)},
