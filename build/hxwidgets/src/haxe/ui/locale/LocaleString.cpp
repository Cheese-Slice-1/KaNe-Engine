...
HX_LOCAL_STACK_FRAME(_hx_pos_4d02f3afcce71e19_142_formatParam,"haxe.ui.locale.LocaleString","formatParam",0x0fcca995,"haxe.ui.locale.LocaleString.formatParam","haxe/ui/locale/LocaleString.hx",142,0x4ee6d6f0)
namespace haxe{
namespace ui{
namespace locale{
...
HXLINE(  64)				result = ::StringTools_obj::replace(result,HX_("[0]",48,37,45,00),this->formatParam(param0));
            			}
HXLINE(  65)			if (::hx::IsNotNull( param1 )) {
HXLINE(  65)				result = ::StringTools_obj::replace(result,HX_("[1]",27,38,45,00),this->formatParam(param1));
            			}
HXLINE(  66)			if (::hx::IsNotNull( param2 )) {
HXLINE(  66)				result = ::StringTools_obj::replace(result,HX_("[2]",06,39,45,00),this->formatParam(param2));
            			}
HXLINE(  67)			if (::hx::IsNotNull( param3 )) {
HXLINE(  67)				result = ::StringTools_obj::replace(result,HX_("[3]",e5,39,45,00),this->formatParam(param3));
            			}
...
::String LocaleString_obj::formatParam( ::Dynamic param){
            	HX_STACKFRAME(&_hx_pos_4d02f3afcce71e19_142_formatParam)
HXLINE( 143)		if (::Std_obj::isOfType(param,::hx::ClassOf< ::Float >())) {
HXLINE( 144)			::String _hx_tmp = ::Std_obj::string(param);
HXDLIN( 144)			return ::StringTools_obj::replace(_hx_tmp,HX_(".",2e,00,00,00),::haxe::ui::locale::Formats_obj::get_decimalSeparator());
            		}
            		else {
HXLINE( 145)			if (::Std_obj::isOfType(param,::hx::ArrayBase::__mClass)) {
HXLINE( 146)				::cpp::VirtualArray arr = ( (::cpp::VirtualArray)(param) );
HXLINE( 147)				::cpp::VirtualArray _g = ::cpp::VirtualArray_obj::__new(0);
HXDLIN( 147)				{
HXLINE( 147)					int _g1 = 0;
HXDLIN( 147)					while((_g1 < arr->get_length())){
HXLINE( 147)						 ::Dynamic x = arr->__get(_g1);
HXDLIN( 147)						_g1 = (_g1 + 1);
HXDLIN( 147)						_g->push(this->formatParam(x));
            					}
            				}
HXDLIN( 147)				return ::Std_obj::string(_g);
            			}
            		}
HXLINE( 150)		return ::Std_obj::string(param);
            	}


HX_DEFINE_DYNAMIC_FUNC1(LocaleString_obj,formatParam,return )
...
::hx::Val LocaleString_obj::__Field(const ::String &inName,::hx::PropertyAccess inCallProp)
{
	...
	case 9:
		...
		break;
	case 11:
		if (HX_FIELD_EQ(inName,"formatParam") ) { return ::hx::Val( formatParam_dyn() ); }
		break;
	case 12:
