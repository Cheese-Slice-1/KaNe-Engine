...
HX_DEFINE_STACK_FRAME(_hx_pos_b11db090752fc413_47_new,"haxe.ui.core.ComponentClassMap","new",0x05877fb6,"haxe.ui.core.ComponentClassMap.new","haxe/ui/core/ComponentClassMap.hx",47,0xb6f7845b)
HX_LOCAL_STACK_FRAME(_hx_pos_b11db090752fc413_54_getClassName,"haxe.ui.core.ComponentClassMap","getClassName",0xa8f6e517,"haxe.ui.core.ComponentClassMap.getClassName","haxe/ui/core/ComponentClassMap.hx",54,0xb6f7845b)
HX_LOCAL_STACK_FRAME(_hx_pos_b11db090752fc413_60_registerClassName,"haxe.ui.core.ComponentClassMap","registerClassName",0x6f480196,"haxe.ui.core.ComponentClassMap.registerClassName","haxe/ui/core/ComponentClassMap.hx",60,0xb6f7845b)
HX_LOCAL_STACK_FRAME(_hx_pos_b11db090752fc413_69_hasClassName,"haxe.ui.core.ComponentClassMap","hasClassName",0x26f22dd3,"haxe.ui.core.ComponentClassMap.hasClassName","haxe/ui/core/ComponentClassMap.hx",69,0xb6f7845b)
HX_LOCAL_STACK_FRAME(_hx_pos_b11db090752fc413_79_load,"haxe.ui.core.ComponentClassMap","load",0xcfbd5610,"haxe.ui.core.ComponentClassMap.load","haxe/ui/core/ComponentClassMap.hx",79,0xb6f7845b)
HX_LOCAL_STACK_FRAME(_hx_pos_b11db090752fc413_95_save,"haxe.ui.core.ComponentClassMap","save",0xd4534727,"haxe.ui.core.ComponentClassMap.save","haxe/ui/core/ComponentClassMap.hx",95,0xb6f7845b)
...
HX_LOCAL_STACK_FRAME(_hx_pos_b11db090752fc413_22_registerClass,"haxe.ui.core.ComponentClassMap","registerClass",0x36bdb1ab,"haxe.ui.core.ComponentClassMap.registerClass","haxe/ui/core/ComponentClassMap.hx",22,0xb6f7845b)
HX_LOCAL_STACK_FRAME(_hx_pos_b11db090752fc413_30_list,"haxe.ui.core.ComponentClassMap","list",0xcfb8d848,"haxe.ui.core.ComponentClassMap.list","haxe/ui/core/ComponentClassMap.hx",30,0xb6f7845b)
HX_LOCAL_STACK_FRAME(_hx_pos_b11db090752fc413_36_clear,"haxe.ui.core.ComponentClassMap","clear",0xc55a2263,"haxe.ui.core.ComponentClassMap.clear","haxe/ui/core/ComponentClassMap.hx",36,0xb6f7845b)
HX_LOCAL_STACK_FRAME(_hx_pos_b11db090752fc413_40_hasClass,"haxe.ui.core.ComponentClassMap","hasClass",0xed73bb68,"haxe.ui.core.ComponentClassMap.hasClass","haxe/ui/core/ComponentClassMap.hx",40,0xb6f7845b)
namespace haxe{
namespace ui{
namespace core{

void ComponentClassMap_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_b11db090752fc413_47_new)
HXDLIN(  47)		this->_map = null();
            	}
...
::String ComponentClassMap_obj::getClassName(::String alias){
            	HX_STACKFRAME(&_hx_pos_b11db090752fc413_54_getClassName)
HXLINE(  55)		this->load();
HXLINE(  56)		alias = alias.toLowerCase();
HXLINE(  57)		return this->_map->get_string(alias);
            	}
...
void ComponentClassMap_obj::registerClassName(::String alias,::String className){
            	HX_STACKFRAME(&_hx_pos_b11db090752fc413_60_registerClassName)
HXLINE(  61)		this->load();
HXLINE(  62)		alias = alias.toLowerCase();
HXLINE(  63)		if ((this->_map->exists(alias) == false)) {
HXLINE(  64)			this->_map->set(alias,className);
            		}
HXLINE(  66)		this->save();
            	}
...
bool ComponentClassMap_obj::hasClassName(::String className){
            	HX_STACKFRAME(&_hx_pos_b11db090752fc413_69_hasClassName)
HXLINE(  70)		this->load();
HXLINE(  71)		{
HXLINE(  71)			 ::Dynamic k = this->_map->keys();
HXDLIN(  71)			while(( (bool)(k->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE(  71)				::String k1 = ( (::String)(k->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
HXLINE(  72)				if (::hx::IsEq( this->_map->get(k1),className )) {
...
void ComponentClassMap_obj::load(){
            	HX_GC_STACKFRAME(&_hx_pos_b11db090752fc413_79_load)
HXLINE(  81)		if (::hx::IsNotNull( this->_map )) {
HXLINE(  82)			return;
            		}
HXLINE(  85)		::String s = ::haxe::Resource_obj::getString(HX_("haxeui_classmap",89,3d,08,ee));
HXLINE(  86)		if (::hx::IsNull( s )) {
HXLINE(  87)			return;
            		}
HXLINE(  90)		 ::haxe::Unserializer unserializer =  ::haxe::Unserializer_obj::__alloc( HX_CTX ,s);
HXLINE(  91)		this->_map = ( ( ::haxe::ds::StringMap)(unserializer->unserialize()) );
            	}
...
void ComponentClassMap_obj::save(){
            	HX_STACKFRAME(&_hx_pos_b11db090752fc413_95_save)
            	}
...
void ComponentClassMap_obj::registerClass(::hx::Class cls,::String alias){
            	HX_STACKFRAME(&_hx_pos_b11db090752fc413_22_registerClass)
HXLINE(  23)		::String className = ::Type_obj::getClassName(cls);
HXLINE(  24)		if (::hx::IsNull( alias )) {
HXLINE(  25)			alias = ( (::String)(className.split(HX_(".",2e,00,00,00))->pop()) ).toLowerCase();
            		}
HXLINE(  27)		 ::haxe::ui::core::ComponentClassMap _hx_tmp = ::haxe::ui::core::ComponentClassMap_obj::get_instance();
HXDLIN(  27)		_hx_tmp->registerClassName(alias.toLowerCase(),className);
            	}


STATIC_HX_DEFINE_DYNAMIC_FUNC2(ComponentClassMap_obj,registerClass,(void))

 ::Dynamic ComponentClassMap_obj::list(){
            	HX_STACKFRAME(&_hx_pos_b11db090752fc413_30_list)
HXLINE(  31)		::haxe::ui::core::ComponentClassMap_obj::get_instance()->load();
HXLINE(  32)		return ::haxe::ui::core::ComponentClassMap_obj::get_instance()->_map->keys();
            	}
...
void ComponentClassMap_obj::clear(){
            	HX_GC_STACKFRAME(&_hx_pos_b11db090752fc413_36_clear)
HXDLIN(  36)		::haxe::ui::core::ComponentClassMap_obj::get_instance()->_map =  ::haxe::ds::StringMap_obj::__alloc( HX_CTX );
            	}
...
bool ComponentClassMap_obj::hasClass(::String className){
            	HX_STACKFRAME(&_hx_pos_b11db090752fc413_40_hasClass)
HXDLIN(  40)		return ::haxe::ui::core::ComponentClassMap_obj::get_instance()->hasClassName(className);
            	}
