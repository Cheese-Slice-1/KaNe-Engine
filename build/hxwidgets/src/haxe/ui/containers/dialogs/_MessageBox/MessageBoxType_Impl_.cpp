...
HX_LOCAL_STACK_FRAME(_hx_pos_74ebfe95e2cd8096_14_toString,"haxe.ui.containers.dialogs._MessageBox.MessageBoxType_Impl_","toString",0x795877c4,"haxe.ui.containers.dialogs._MessageBox.MessageBoxType_Impl_.toString","haxe/ui/containers/dialogs/MessageBox.hx",14,0x05c2afab)
...
HX_LOCAL_STACK_FRAME(_hx_pos_74ebfe95e2cd8096_11_boot,"haxe.ui.containers.dialogs._MessageBox.MessageBoxType_Impl_","boot",0x9b2dbf4a,"haxe.ui.containers.dialogs._MessageBox.MessageBoxType_Impl_.boot","haxe/ui/containers/dialogs/MessageBox.hx",11,0x05c2afab)
namespace haxe{
namespace ui{
...
bool MessageBoxType_Impl__obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x66c751c6;
}
...
::String MessageBoxType_Impl__obj::TYPE_YESNO;

::String MessageBoxType_Impl__obj::toString(::String this1){
            	HX_STACKFRAME(&_hx_pos_74ebfe95e2cd8096_14_toString)
HXDLIN(  14)		return ::Std_obj::string(this1);
            	}
...
static ::hx::StaticInfo MessageBoxType_Impl__obj_sStaticStorageInfo[] = {
	...
	{::hx::fsString,(void *) &MessageBoxType_Impl__obj::TYPE_YESNO,HX_("TYPE_YESNO",83,62,d5,eb)},
	{ ::hx::fsUnknown, 0, null()}
};
#endif
...
static void MessageBoxType_Impl__obj_sMarkStatics(HX_MARK_PARAMS) {
	...
	HX_MARK_MEMBER_NAME(MessageBoxType_Impl__obj::TYPE_YESNO,"TYPE_YESNO");
};
...
static void MessageBoxType_Impl__obj_sVisitStatics(HX_VISIT_PARAMS) {
	...
	HX_VISIT_MEMBER_NAME(MessageBoxType_Impl__obj::TYPE_YESNO,"TYPE_YESNO");
};
...
{
            	HX_STACKFRAME(&_hx_pos_74ebfe95e2cd8096_11_boot)
HXDLIN(  11)		TYPE_YESNO = HX_("yesno",28,61,96,ee);
            	}
}
